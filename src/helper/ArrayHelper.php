...
namespace Enpii\Wp\EnpiiBase\Helper;

/**
 * Class ArrayHelper
 * @package Enpii\Wp\EnpiiBase\Helpers
 * Based on this https://github.com/yiisoft/yii2/blob/master/framework/helpers/BaseArrayHelper.php
 */
class ArrayHelper {
	/**
