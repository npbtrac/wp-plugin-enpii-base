...
use Enpii_Base\Deps\Symfony\Component\ErrorHandler\ErrorRenderer\ErrorRendererInterface;
...
class ErrorController
{
    ...
    public function preview(Request $request, int $code): Response
    {
         ...
         * \Enpii_Base\Deps\Symfony\Component\HttpKernel\EventListener\ErrorListener::duplicateRequest, with
