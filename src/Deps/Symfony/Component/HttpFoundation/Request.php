...
namespace Enpii_Base\Deps\Symfony\Component\HttpFoundation;

use Enpii_Base\Deps\Symfony\Component\HttpFoundation\Exception\ConflictingHeadersException;
use Enpii_Base\Deps\Symfony\Component\HttpFoundation\Exception\JsonException;
use Enpii_Base\Deps\Symfony\Component\HttpFoundation\Exception\SessionNotFoundException;
    ...
    private static function createRequestFromFactory(array $query = [], array $request = [], array $attributes = [], array $cookies = [], array $files = [], array $server = [], $content = null): self
    {
        if (self::$requestFactory) {
            ...
            if (!$request instanceof self) {
                throw new \LogicException('The Request factory must return an instance of Enpii_Base\Deps\Symfony\Component\HttpFoundation\Request.');
            }
