...
namespace Enpii_Base\Deps\Ramsey\Uuid\Math;

use Enpii_Base\Deps\Brick\Math\BigDecimal;
use Enpii_Base\Deps\Brick\Math\BigInteger;
use Enpii_Base\Deps\Brick\Math\Exception\MathException;
use Enpii_Base\Deps\Brick\Math\RoundingMode as BrickMathRounding;
use Enpii_Base\Deps\Ramsey\Uuid\Exception\InvalidArgumentException;
use Enpii_Base\Deps\Ramsey\Uuid\Type\Decimal;
use Enpii_Base\Deps\Ramsey\Uuid\Type\Hexadecimal;
use Enpii_Base\Deps\Ramsey\Uuid\Type\Integer as IntegerObject;
use Enpii_Base\Deps\Ramsey\Uuid\Type\NumberInterface;
