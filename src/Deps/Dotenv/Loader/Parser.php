...
use Enpii_Base\Deps\Dotenv\Regex\Regex;
use Enpii_Base\Deps\Dotenv\Result\Error;
use Enpii_Base\Deps\Dotenv\Result\Success;
...
class Parser
{
     ...
     *
     * @return array{string,\Enpii_Base\Deps\Dotenv\Loader\Value|null}
     */
     ...
     * @throws \Enpii_Base\Deps\Dotenv\Exception\InvalidFileException
     *
     * @return \Enpii_Base\Deps\Dotenv\Loader\Value|null
     */
     ...
     * @param string $char
     *
     * @return \Enpii_Base\Deps\Dotenv\Result\Result<array{string,bool,int},string>
     */
    private static function processChar($state, $char)
    {
        switch ($state) {
            case self::INITIAL_STATE:
                if ($char === '\'') {
                    /** @var \Enpii_Base\Deps\Dotenv\Result\Result<array{string,bool,int},string> */
