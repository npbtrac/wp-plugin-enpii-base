...
trait Serialization
{
    ...
    /**
     * The custom Enpii_Base\Deps\Carbon JSON serializer.
     *
     * @var callable|null
     */
     ...
     *             You should rather transform Enpii_Base\Deps\Carbon object before the serialization.
     *
     * JSON serialize all Enpii_Base\Deps\Carbon instances using the given callback.
     *
