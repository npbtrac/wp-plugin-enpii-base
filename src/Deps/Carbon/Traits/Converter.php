...
use Enpii_Base\Deps\Carbon\Exceptions\UnitException;
use Closure;
use DateTime;
...
trait Converter
{
     ...
     * @example
     * ```
     * echo Carbon::now(); // Enpii_Base\Deps\Carbon instances can be cast to string
     * ```
     *
     * @return string
     */
     ...
     *
     * @param \DateTimeInterface|Enpii_Base\Deps\Carbon|CarbonImmutable|int|null $end      period end date or recurrences count if int
     ...
     * Create a iterable CarbonPeriod object from current date to a given end date (and optional interval).
     *
     * @param \DateTimeInterface|Enpii_Base\Deps\Carbon|CarbonImmutable|null $end      period end date
     * @param int|\DateInterval|string|null                  $interval period default interval or number of the given $unit
     * @param string|null                                    $unit     if specified, $interval must be an integer
     *
     * @return CarbonPeriod
