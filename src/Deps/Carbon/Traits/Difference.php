...
use Enpii_Base\Deps\Carbon\CarbonInterval;
use Enpii_Base\Deps\Carbon\CarbonPeriod;
...
trait Difference
{
     ...
     * current one).
     *
     * @param \Enpii_Base\Deps\Carbon\CarbonInterface|\DateTimeInterface|string|null $date
    ...
    public function floatDiffInMonths($date = null, $absolute = true)
    {
        ...
        /** @var Enpii_Base\Deps\Carbon|CarbonImmutable $floorEnd */
        ...
        /** @var Enpii_Base\Deps\Carbon|CarbonImmutable $startOfMonthAfterFloorEnd */
    ...
    public function floatDiffInYears($date = null, $absolute = true)
    {
        ...
        /** @var Enpii_Base\Deps\Carbon|CarbonImmutable $startOfYearAfterFloorEnd */
     ...
     * ```
     *
     * @param Enpii_Base\Deps\Carbon|\DateTimeInterface|string|array|null $other   if array passed, will be used as parameters array, see $syntax below;
     ...
     *
     * @param Enpii_Base\Deps\Carbon|\DateTimeInterface|string|null $referenceTime
     * @param array                                 $formats
     *
     * @return string
     */
