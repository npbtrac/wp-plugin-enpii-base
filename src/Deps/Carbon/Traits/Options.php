 ...
 * Trait Options.
 *
 * Embed base methods to change settings of Enpii_Base\Deps\Carbon classes.
 *
 * Depends on the following methods:
 *
 * @method \Enpii_Base\Deps\Carbon\Carbon|\Enpii_Base\Deps\Carbon\CarbonImmutable shiftTimezone($timezone) Set the timezone
 */
trait Options
{
    use Localization;
