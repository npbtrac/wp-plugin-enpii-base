...
use Enpii_Base\Deps\Carbon\CarbonTimeZone;
use Closure;
...
trait Test
{
    ...
    /**
     * A test Enpii_Base\Deps\Carbon instance to be returned when now instances are created.
     *
    ...
    /**
     * Set a Enpii_Base\Deps\Carbon instance (real or mock) to be returned when a "now"
     ...
     *
     * @param DateTimeInterface|Closure|static|string|false|null $testNow real or mock Enpii_Base\Deps\Carbon instance
     */
    ...
    /**
     * Get the Enpii_Base\Deps\Carbon instance (real or mock) to be returned when a "now"
     * instance is created.
     *
     ...
     *
     * @return \Enpii_Base\Deps\Carbon\CarbonImmutable|\Enpii_Base\Deps\Carbon\Carbon|null
     */
    protected static function getMockedTestNow($tz)
    {
        ...
        /* @var \Enpii_Base\Deps\Carbon\CarbonImmutable|\Enpii_Base\Deps\Carbon\Carbon|null $testNow */
    ...
    {
        /** @var \Enpii_Base\Deps\Carbon\CarbonImmutable|\Enpii_Base\Deps\Carbon\Carbon $testInstance */
