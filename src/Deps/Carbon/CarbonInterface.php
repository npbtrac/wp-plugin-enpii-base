...
/**
 * Common interface for Enpii_Base\Deps\Carbon and CarbonImmutable.
 *
 ...
 * @property-read string           $dayName                                                                           long name of weekday translated according to Enpii_Base\Deps\Carbon locale, in english if no translation available for current language
 * @property-read string           $shortDayName                                                                      short name of weekday translated according to Enpii_Base\Deps\Carbon locale, in english if no translation available for current language
 * @property-read string           $minDayName                                                                        very short name of weekday translated according to Enpii_Base\Deps\Carbon locale, in english if no translation available for current language
 * @property-read string           $monthName                                                                         long name of month translated according to Enpii_Base\Deps\Carbon locale, in english if no translation available for current language
 * @property-read string           $shortMonthName                                                                    short name of month translated according to Enpii_Base\Deps\Carbon locale, in english if no translation available for current language
 * @property-read string           $meridiem                                                                          lowercase meridiem mark translated according to Enpii_Base\Deps\Carbon locale, in latin if no translation available for current language
 * @property-read string           $upperMeridiem                                                                     uppercase meridiem mark translated according to Enpii_Base\Deps\Carbon locale, in latin if no translation available for current language
 ...
 * @method        bool             isSameYear(Enpii_Base\Deps\Carbon|DateTimeInterface|string|null $date = null)                      Checks if the given date is in the same year as the instance. If null passed, compare to now (with the same timezone).
 * @method        bool             isCurrentYear()                                                                    Checks if the instance is in the same year as the current moment.
 * @method        bool             isNextYear()                                                                       Checks if the instance is in the same year as the current moment next year.
 * @method        bool             isLastYear()                                                                       Checks if the instance is in the same year as the current moment last year.
 * @method        bool             isSameWeek(Enpii_Base\Deps\Carbon|DateTimeInterface|string|null $date = null)                      Checks if the given date is in the same week as the instance. If null passed, compare to now (with the same timezone).
 * @method        bool             isCurrentWeek()                                                                    Checks if the instance is in the same week as the current moment.
 * @method        bool             isNextWeek()                                                                       Checks if the instance is in the same week as the current moment next week.
 * @method        bool             isLastWeek()                                                                       Checks if the instance is in the same week as the current moment last week.
 * @method        bool             isSameDay(Enpii_Base\Deps\Carbon|DateTimeInterface|string|null $date = null)                       Checks if the given date is in the same day as the instance. If null passed, compare to now (with the same timezone).
 * @method        bool             isCurrentDay()                                                                     Checks if the instance is in the same day as the current moment.
 * @method        bool             isNextDay()                                                                        Checks if the instance is in the same day as the current moment next day.
 * @method        bool             isLastDay()                                                                        Checks if the instance is in the same day as the current moment last day.
 * @method        bool             isSameHour(Enpii_Base\Deps\Carbon|DateTimeInterface|string|null $date = null)                      Checks if the given date is in the same hour as the instance. If null passed, compare to now (with the same timezone).
 * @method        bool             isCurrentHour()                                                                    Checks if the instance is in the same hour as the current moment.
 * @method        bool             isNextHour()                                                                       Checks if the instance is in the same hour as the current moment next hour.
 * @method        bool             isLastHour()                                                                       Checks if the instance is in the same hour as the current moment last hour.
 * @method        bool             isSameMinute(Enpii_Base\Deps\Carbon|DateTimeInterface|string|null $date = null)                    Checks if the given date is in the same minute as the instance. If null passed, compare to now (with the same timezone).
 * @method        bool             isCurrentMinute()                                                                  Checks if the instance is in the same minute as the current moment.
 * @method        bool             isNextMinute()                                                                     Checks if the instance is in the same minute as the current moment next minute.
 * @method        bool             isLastMinute()                                                                     Checks if the instance is in the same minute as the current moment last minute.
 * @method        bool             isSameSecond(Enpii_Base\Deps\Carbon|DateTimeInterface|string|null $date = null)                    Checks if the given date is in the same second as the instance. If null passed, compare to now (with the same timezone).
 * @method        bool             isCurrentSecond()                                                                  Checks if the instance is in the same second as the current moment.
 * @method        bool             isNextSecond()                                                                     Checks if the instance is in the same second as the current moment next second.
 * @method        bool             isLastSecond()                                                                     Checks if the instance is in the same second as the current moment last second.
 * @method        bool             isSameMicro(Enpii_Base\Deps\Carbon|DateTimeInterface|string|null $date = null)                     Checks if the given date is in the same microsecond as the instance. If null passed, compare to now (with the same timezone).
 * @method        bool             isCurrentMicro()                                                                   Checks if the instance is in the same microsecond as the current moment.
 * @method        bool             isNextMicro()                                                                      Checks if the instance is in the same microsecond as the current moment next microsecond.
 * @method        bool             isLastMicro()                                                                      Checks if the instance is in the same microsecond as the current moment last microsecond.
 * @method        bool             isSameMicrosecond(Enpii_Base\Deps\Carbon|DateTimeInterface|string|null $date = null)               Checks if the given date is in the same microsecond as the instance. If null passed, compare to now (with the same timezone).
 ...
 * @method        bool             isSameDecade(Enpii_Base\Deps\Carbon|DateTimeInterface|string|null $date = null)                    Checks if the given date is in the same decade as the instance. If null passed, compare to now (with the same timezone).
 * @method        bool             isCurrentDecade()                                                                  Checks if the instance is in the same decade as the current moment.
 * @method        bool             isNextDecade()                                                                     Checks if the instance is in the same decade as the current moment next decade.
 * @method        bool             isLastDecade()                                                                     Checks if the instance is in the same decade as the current moment last decade.
 * @method        bool             isSameCentury(Enpii_Base\Deps\Carbon|DateTimeInterface|string|null $date = null)                   Checks if the given date is in the same century as the instance. If null passed, compare to now (with the same timezone).
 * @method        bool             isCurrentCentury()                                                                 Checks if the instance is in the same century as the current moment.
 * @method        bool             isNextCentury()                                                                    Checks if the instance is in the same century as the current moment next century.
 * @method        bool             isLastCentury()                                                                    Checks if the instance is in the same century as the current moment last century.
 * @method        bool             isSameMillennium(Enpii_Base\Deps\Carbon|DateTimeInterface|string|null $date = null)                Checks if the given date is in the same millennium as the instance. If null passed, compare to now (with the same timezone).
 ...
 * @method        CarbonPeriod     microsUntil($endDate = null, int $factor = 1)                                      Return an iterable period from current date to given end (string, DateTime or Enpii_Base\Deps\Carbon instance) for each microsecond or every X microseconds if a factor is given.
 ...
 * @method        CarbonPeriod     microsecondsUntil($endDate = null, int $factor = 1)                                Return an iterable period from current date to given end (string, DateTime or Enpii_Base\Deps\Carbon instance) for each microsecond or every X microseconds if a factor is given.
 ...
 * @method        CarbonPeriod     millisUntil($endDate = null, int $factor = 1)                                      Return an iterable period from current date to given end (string, DateTime or Enpii_Base\Deps\Carbon instance) for each millisecond or every X milliseconds if a factor is given.
 ...
 * @method        CarbonPeriod     millisecondsUntil($endDate = null, int $factor = 1)                                Return an iterable period from current date to given end (string, DateTime or Enpii_Base\Deps\Carbon instance) for each millisecond or every X milliseconds if a factor is given.
 ...
 * @method        CarbonPeriod     secondsUntil($endDate = null, int $factor = 1)                                     Return an iterable period from current date to given end (string, DateTime or Enpii_Base\Deps\Carbon instance) for each second or every X seconds if a factor is given.
 ...
 * @method        CarbonPeriod     minutesUntil($endDate = null, int $factor = 1)                                     Return an iterable period from current date to given end (string, DateTime or Enpii_Base\Deps\Carbon instance) for each minute or every X minutes if a factor is given.
 ...
 * @method        CarbonPeriod     hoursUntil($endDate = null, int $factor = 1)                                       Return an iterable period from current date to given end (string, DateTime or Enpii_Base\Deps\Carbon instance) for each hour or every X hours if a factor is given.
 ...
 * @method        CarbonPeriod     daysUntil($endDate = null, int $factor = 1)                                        Return an iterable period from current date to given end (string, DateTime or Enpii_Base\Deps\Carbon instance) for each day or every X days if a factor is given.
 ...
 * @method        CarbonPeriod     weeksUntil($endDate = null, int $factor = 1)                                       Return an iterable period from current date to given end (string, DateTime or Enpii_Base\Deps\Carbon instance) for each week or every X weeks if a factor is given.
 ...
 * @method        CarbonPeriod     monthsUntil($endDate = null, int $factor = 1)                                      Return an iterable period from current date to given end (string, DateTime or Enpii_Base\Deps\Carbon instance) for each month or every X months if a factor is given.
 ...
 * @method        CarbonPeriod     quartersUntil($endDate = null, int $factor = 1)                                    Return an iterable period from current date to given end (string, DateTime or Enpii_Base\Deps\Carbon instance) for each quarter or every X quarters if a factor is given.
 ...
 * @method        CarbonPeriod     yearsUntil($endDate = null, int $factor = 1)                                       Return an iterable period from current date to given end (string, DateTime or Enpii_Base\Deps\Carbon instance) for each year or every X years if a factor is given.
 ...
 * @method        CarbonPeriod     decadesUntil($endDate = null, int $factor = 1)                                     Return an iterable period from current date to given end (string, DateTime or Enpii_Base\Deps\Carbon instance) for each decade or every X decades if a factor is given.
 ...
 * @method        CarbonPeriod     centuriesUntil($endDate = null, int $factor = 1)                                   Return an iterable period from current date to given end (string, DateTime or Enpii_Base\Deps\Carbon instance) for each century or every X centuries if a factor is given.
 ...
 * @method        CarbonPeriod     millenniaUntil($endDate = null, int $factor = 1)                                   Return an iterable period from current date to given end (string, DateTime or Enpii_Base\Deps\Carbon instance) for each millennium or every X millennia if a factor is given.
...
interface CarbonInterface extends DateTimeInterface, JsonSerializable
{
    ...
    /**
     * The month constants.
     * These aren't used by Enpii_Base\Deps\Carbon itself but exist for
    ...
    /**
     * Get a part of the Enpii_Base\Deps\Carbon object
     *
     * @param string $name
     *
    ...
    /**
     * Set a part of the Enpii_Base\Deps\Carbon object
     *
     * @param string                  $name
     ...
     * @example
     * ```
     * echo Carbon::now(); // Enpii_Base\Deps\Carbon instances can be casted to string
     * ```
     *
     * @return string
     */
     ...
     *
     * @param Enpii_Base\Deps\Carbon|\Enpii_Base\Deps\Carbon\CarbonPeriod|\Enpii_Base\Deps\Carbon\CarbonInterval|\DateInterval|\DatePeriod|DateTimeInterface|string|null $date
     *
     * @return static
     */
     ...
     *
     * @param string $unit      Enpii_Base\Deps\Carbon unit name
     ...
     *
     * @param Enpii_Base\Deps\Carbon|DateTimeInterface $date now if null
     *
     * @return static
     */
     ...
     *
     * @param Enpii_Base\Deps\Carbon|DateTimeInterface $date
     *
     * @return static
     */
     ...
     *
     * @param Closure|static|string|false|null $testNow real or mock Enpii_Base\Deps\Carbon instance
     */
    ...
    /**
     * @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
     *             You should rather let Enpii_Base\Deps\Carbon object being casted to string with DEFAULT_TO_STRING_FORMAT, and
