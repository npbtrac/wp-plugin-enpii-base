...
class Logger implements LoggerInterface, ResettableInterface
{
    ...
    /**
     * Enpii_Base\Deps\Monolog API version
     *
    ...
    /**
     * Mapping between levels numbers defined in RFC 5424 and Enpii_Base\Deps\Monolog ones
     *
     ...
     * there is no performance penalty and Enpii_Base\Deps\Monolog 2 enabled microseconds
     ...
     * Adds a log record.
     *
     * @param  int               $level    The logging level (a Enpii_Base\Deps\Monolog or RFC 5424 level)
     ...
     *
     * @throws \Enpii_Base\Deps\Psr\Log\InvalidArgumentException If level is not defined
     *
     * @phpstan-param  Level     $level
    ...
    /**
     * Converts PSR-3 levels to Enpii_Base\Deps\Monolog ones if necessary
     *
