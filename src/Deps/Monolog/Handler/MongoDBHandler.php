...
use Enpii_Base\Deps\Monolog\Formatter\MongoDBFormatter;
 ...
 * Usage example:
 *
 *   $log = new \Enpii_Base\Deps\Monolog\Logger('application');
 *   $client = new \MongoDB\Client('mongodb://localhost:27017');
 *   $mongodb = new \Enpii_Base\Deps\Monolog\Handler\MongoDBHandler($client, 'logs', 'prod');
