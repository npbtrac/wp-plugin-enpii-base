...
use Enpii_Base\Deps\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use Enpii_Base\Deps\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
use Enpii_Base\Deps\Monolog\Logger;
use Enpii_Base\Deps\Monolog\ResettableInterface;
 ...
 * Enpii_Base\Deps\Monolog\Handler\FingersCrossed\ namespace.
 *
...
class FingersCrossedHandler extends Handler implements ProcessableHandlerInterface, ResettableInterface, FormattableHandlerInterface
{
    ...
    public function __construct($handler, $activationStrategy = null, int $bufferSize = 0, bool $bubble = true, bool $stopBuffering = true, $passthruLevel = null)
    {
        ...
        if (!$this->handler instanceof HandlerInterface && !is_callable($this->handler)) {
            throw new \RuntimeException("The given handler (".json_encode($this->handler).") is not a callable nor a Enpii_Base\Deps\Monolog\Handler\HandlerInterface object");
        }
    }
