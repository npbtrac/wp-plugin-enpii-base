...
use Closure;
use Enpii_Base\Deps\Illuminate\Contracts\Auth\Factory as FactoryContract;
...
class AuthManager implements FactoryContract
{
     ...
     * @param  string  $name
     * @param  array  $config
     * @return \Enpii_Base\Deps\Illuminate\Auth\SessionGuard
     */
     ...
     * @param  string  $name
     * @param  array  $config
     * @return \Enpii_Base\Deps\Illuminate\Auth\TokenGuard
     */
