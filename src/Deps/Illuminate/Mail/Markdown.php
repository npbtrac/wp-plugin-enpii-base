...
use Enpii_Base\Deps\League\CommonMark\CommonMarkConverter;
use Enpii_Base\Deps\League\CommonMark\Environment;
use Enpii_Base\Deps\League\CommonMark\Extension\Table\TableExtension;
use Enpii_Base\Deps\TijsVerkoyen\CssToInlineStyles\CssToInlineStyles;
...
class Markdown
{
     ...
     * @param  string  $view
     * @param  array  $data
     * @param  \Enpii_Base\Deps\TijsVerkoyen\CssToInlineStyles\CssToInlineStyles|null  $inliner
