...
use Enpii_Base\Deps\Illuminate\Contracts\Queue\Factory as QueueManager;
use Enpii_Base\Deps\Illuminate\Database\DetectsLostConnections;
use Enpii_Base\Deps\Illuminate\Queue\Events\JobExceptionOccurred;
use Enpii_Base\Deps\Illuminate\Queue\Events\JobProcessed;
use Enpii_Base\Deps\Illuminate\Queue\Events\JobProcessing;
use Enpii_Base\Deps\Illuminate\Queue\Events\Looping;
use Enpii_Base\Deps\Illuminate\Queue\Events\WorkerStopping;
...
class Worker
{
     ...
     *
     * @param  \Enpii_Base\Deps\Illuminate\Contracts\Queue\Factory  $manager
     * @param  \Enpii_Base\Deps\Illuminate\Contracts\Events\Dispatcher  $events
     * @param  \Enpii_Base\Deps\Illuminate\Contracts\Debug\ExceptionHandler  $exceptions
     ...
     * @param  string  $queue
     * @param  \Enpii_Base\Deps\Illuminate\Queue\WorkerOptions  $options
     * @return void
     */
     ...
     *
     * @param  \Enpii_Base\Deps\Illuminate\Contracts\Queue\Job|null  $job
     * @param  \Enpii_Base\Deps\Illuminate\Queue\WorkerOptions  $options
     * @return void
     */
     ...
     *
     * @param  \Enpii_Base\Deps\Illuminate\Contracts\Queue\Queue  $connection
     * @param  string  $queue
     * @return \Enpii_Base\Deps\Illuminate\Contracts\Queue\Job|null
     */
     ...
     *
     * @param  \Enpii_Base\Deps\Illuminate\Contracts\Queue\Job  $job
     * @return \Enpii_Base\Deps\Illuminate\Queue\MaxAttemptsExceededException
     */
     ...
     *
     * @return \Enpii_Base\Deps\Illuminate\Queue\QueueManager
     */
