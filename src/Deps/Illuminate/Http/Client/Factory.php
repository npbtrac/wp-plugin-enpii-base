...
class Factory
{
     ...
     * @return \Enpii_Base\Deps\Illuminate\Http\Client\ResponseSequence
     */
     ...
     *
     * @param  string  $url
     * @param  \Enpii_Base\Deps\Illuminate\Http\Client\Response|\GuzzleHttp\Promise\PromiseInterface|callable  $callback
     * @return $this
     */
     ...
     *
     * @param  \Enpii_Base\Deps\Illuminate\Http\Client\Request  $request
