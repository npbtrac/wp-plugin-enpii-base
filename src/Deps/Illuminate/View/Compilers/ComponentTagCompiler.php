...
use Enpii_Base\Deps\Illuminate\View\AnonymousComponent;
use Enpii_Base\Deps\Illuminate\View\ViewFinderInterface;
...
class ComponentTagCompiler
{
     ...
     *
     * @var \Enpii_Base\Deps\Illuminate\View\Compilers\BladeCompiler
     */
    protected $blade;
     ...
     *
     * @param  array  $aliases
     * @param  \Enpii_Base\Deps\Illuminate\View\Compilers\BladeCompiler|null
     * @return void
     */
        ...
        return wp_app_collect($attributes)
                ->map(function (string $value, string $attribute) use ($escapeBound) {
                    return $escapeBound && isset($this->boundAttributes[$attribute]) && $value !== 'true' && ! is_numeric($value)
                                ? "'{$attribute}' => \Enpii_Base\Deps\Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute({$value})"
                                : "'{$attribute}' => {$value}";
                })
                ->implode(',');
    }
