...
use Enpii_Base\Deps\Illuminate\Contracts\Routing\BindingRegistrar;
use Enpii_Base\Deps\Illuminate\Contracts\Routing\Registrar as RegistrarContract;
...
use Enpii_Base\Deps\Illuminate\Routing\Events\RouteMatched;
...
/**
 * @mixin \Enpii_Base\Deps\Illuminate\Routing\RouteRegistrar
 */
class Router implements BindingRegistrar, RegistrarContract
{
     ...
     *
     * @var \Enpii_Base\Deps\Illuminate\Routing\RouteCollectionInterface
     */
    protected $routes;
     ...
     *
     * @var \Enpii_Base\Deps\Illuminate\Routing\Route|null
     */
    protected $current;
     ...
     * @param  \Enpii_Base\Deps\Illuminate\Container\Container|null  $container
     * @return void
     */
    ...
    {
        return $this->any($uri, '\Enpii_Base\Deps\Illuminate\Routing\RedirectController')
    ...
    {
        return $this->match(['GET', 'HEAD'], $uri, '\Enpii_Base\Deps\Illuminate\Routing\ViewController')
                ->defaults('view', $view)
                ->defaults('data', $data);
    }
     ...
     *
     * @param  \Enpii_Base\Deps\Illuminate\Support\Collection  $middlewares
     * @return array
     */
     ...
     *
     * @return \Enpii_Base\Deps\Illuminate\Http\Request
     */
     ...
     *
     * @return \Enpii_Base\Deps\Illuminate\Routing\RouteCollectionInterface
     */
     ...
     *
     * @param  \Enpii_Base\Deps\Illuminate\Routing\RouteCollection  $routes
     * @return void
     */
