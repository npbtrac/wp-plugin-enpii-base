...
use Enpii_Base\Deps\Illuminate\Contracts\Database\Eloquent\Castable;
use Enpii_Base\Deps\Illuminate\Contracts\Database\Eloquent\CastsInboundAttributes;
use Enpii_Base\Deps\Illuminate\Contracts\Support\Arrayable;
use Enpii_Base\Deps\Illuminate\Database\Eloquent\JsonEncodingException;
...
trait HasAttributes
{
    ...
    public function attributesToArray()
    {
        ...
        // to a DateTime / Enpii_Base\Deps\Carbon instance. This is so we will get some consistent
    ...
    {
        // If this value is already a Enpii_Base\Deps\Carbon instance, we shall just return it as is.
        // This prevents us having to re-instantiate a Enpii_Base\Deps\Carbon instance when we know
        ...
        // and format a Enpii_Base\Deps\Carbon object from this timestamp. This allows flexibility
        ...
        // Enpii_Base\Deps\Carbon instances from that format. Again, this provides for simple date
        ...
        // the database connection and use that format to create the Enpii_Base\Deps\Carbon object
