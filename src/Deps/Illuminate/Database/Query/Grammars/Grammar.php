...
namespace Enpii_Base\Deps\Illuminate\Database\Query\Grammars;

use Enpii_Base\Deps\Illuminate\Database\Grammar as BaseGrammar;
use Enpii_Base\Deps\Illuminate\Database\Query\Builder;
use Enpii_Base\Deps\Illuminate\Database\Query\JoinClause;
