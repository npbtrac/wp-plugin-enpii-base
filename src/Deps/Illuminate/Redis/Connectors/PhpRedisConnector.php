...
use Enpii_Base\Deps\Illuminate\Redis\Connections\PhpRedisClusterConnection;
use Enpii_Base\Deps\Illuminate\Redis\Connections\PhpRedisConnection;
use Enpii_Base\Deps\Illuminate\Support\Arr;
use Enpii_Base\Deps\Illuminate\Support\Facades\Redis as RedisFacade;
...
class PhpRedisConnector implements Connector
{
     ...
     * @param  array  $config
     * @param  array  $options
     * @return \Enpii_Base\Deps\Illuminate\Redis\Connections\PhpRedisConnection
     */
     ...
     * @param  array  $options
     * @return \Enpii_Base\Deps\Illuminate\Redis\Connections\PhpRedisClusterConnection
     */
