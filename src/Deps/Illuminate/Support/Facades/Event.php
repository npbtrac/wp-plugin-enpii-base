...
use Enpii_Base\Deps\Illuminate\Support\Testing\Fakes\EventFake;

/**
 * @method static \Closure createClassListener(string $listener, bool $wildcard = false)
 * @method static \Closure makeListener(\Closure|string $listener, bool $wildcard = false)
 * @method static \Enpii_Base\Deps\Illuminate\Events\Dispatcher setQueueResolver(callable $resolver)
 ...
 *
 * @see \Enpii_Base\Deps\Illuminate\Events\Dispatcher
 */
class Event extends Facade
{
     ...
     * @return \Enpii_Base\Deps\Illuminate\Support\Testing\Fakes\EventFake
     */
