...
namespace Enpii_Base\Deps\Illuminate\Testing;

use ArrayAccess;
use Closure;
use Enpii_Base\Deps\Illuminate\Contracts\View\View;
use Enpii_Base\Deps\Illuminate\Cookie\CookieValuePrefix;
...
use Enpii_Base\Deps\Illuminate\Support\Traits\Tappable;
use Enpii_Base\Deps\Illuminate\Testing\Assert as PHPUnit;
use Enpii_Base\Deps\Illuminate\Testing\Constraints\SeeInOrder;
use LogicException;
use Enpii_Base\Deps\Symfony\Component\HttpFoundation\StreamedResponse;

/**
 * @mixin \Enpii_Base\Deps\Illuminate\Http\Response
 */
class TestResponse implements ArrayAccess
{
     ...
     *
     * @param  string  $cookieName
     * @return \Enpii_Base\Deps\Symfony\Component\HttpFoundation\Cookie|null
     */
