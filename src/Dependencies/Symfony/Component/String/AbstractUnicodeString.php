...
{
    public const NFC = \NpWpNPB_NpWpNPB_NpWpNPB_NpWpNPB_NpWpNPB_Normalizer::NFC;
    public const NFD = \NpWpNPB_NpWpNPB_NpWpNPB_NpWpNPB_NpWpNPB_Normalizer::NFD;
    public const NFKC = \NpWpNPB_NpWpNPB_NpWpNPB_NpWpNPB_NpWpNPB_Normalizer::NFKC;
    public const NFKD = \NpWpNPB_NpWpNPB_NpWpNPB_NpWpNPB_NpWpNPB_Normalizer::NFKD;
    ...
    public function folded(bool $compat = true): parent
    {
        ...
        if (!$compat || \PHP_VERSION_ID < 70300 || !\defined('NpWpNPB_NpWpNPB_NpWpNPB_NpWpNPB_NpWpNPB_Normalizer::NFKC_CF')) {
            $str->string = normalizer_normalize($str->string, $compat ? \NpWpNPB_NpWpNPB_NpWpNPB_NpWpNPB_NpWpNPB_Normalizer::NFKC : \NpWpNPB_NpWpNPB_NpWpNPB_NpWpNPB_NpWpNPB_Normalizer::NFC);
            $str->string = mb_strtolower(str_replace(self::FOLD_FROM, self::FOLD_TO, $this->string), 'UTF-8');
        } else {
            $str->string = normalizer_normalize($str->string, \NpWpNPB_NpWpNPB_NpWpNPB_NpWpNPB_NpWpNPB_Normalizer::NFKC_CF);
        }
