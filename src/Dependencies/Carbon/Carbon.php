...
use Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon\Traits\Date;
use Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon\Traits\DeprecatedProperties;
use DateTime;
 ...
 * @method        static Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon|false createFromFormat(string $format, string $time, string|DateTimeZone $timezone = null) Parse a string into a new Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon object according to the specified format.
 * @method        static Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon       __set_state(array $array)                                                            https://php.net/manual/en/datetime.set-state.php
 *
 * </autodoc>
 */
