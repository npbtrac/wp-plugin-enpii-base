...
/**
 * A factory to generate Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instances with common settings.
 *
 ...
 *                                                                                                                                                                                         new instance.
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon|false                                       create($year = 0, $month = 1, $day = 1, $hour = 0, $minute = 0, $second = 0, $tz = null)                                     Create a new Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance from a specific date and time.
 ...
 *                                                                                                                                                                                         will be 0.
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             createFromDate($year = null, $month = null, $day = null, $tz = null)                                                         Create a Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance from just a date. The time portion is set to now.
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon|false                                       createFromFormat($format, $time, $tz = null)                                                                                 Create a Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance from a specific format.
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon|false                                       createFromIsoFormat($format, $time, $tz = null, $locale = 'en', $translator = null)                                          Create a Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance from a specific ISO format (same replacements as ->isoFormat()).
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon|false                                       createFromLocaleFormat($format, $locale, $time, $tz = null)                                                                  Create a Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance from a specific format and a string in a given language.
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon|false                                       createFromLocaleIsoFormat($format, $locale, $time, $tz = null)                                                               Create a Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance from a specific ISO format and a string in a given language.
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             createFromTime($hour = 0, $minute = 0, $second = 0, $tz = null)                                                              Create a Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance from just a time. The date portion is set to today.
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             createFromTimeString($time, $tz = null)                                                                                      Create a Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance from a time string. The date portion is set to today.
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             createFromTimestamp($timestamp, $tz = null)                                                                                  Create a Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance from a timestamp and set the timezone (use default one if not specified).
 *                                                                                                                                                                                         Timestamp input can be given as int, float or a string containing one or more numbers.
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             createFromTimestampMs($timestamp, $tz = null)                                                                                Create a Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance from a timestamp in milliseconds.
 *                                                                                                                                                                                         Timestamp input can be given as int, float or a string containing one or more numbers.
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             createFromTimestampMsUTC($timestamp)                                                                                         Create a Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance from a timestamp in milliseconds.
 *                                                                                                                                                                                         Timestamp input can be given as int, float or a string containing one or more numbers.
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             createFromTimestampUTC($timestamp)                                                                                           Create a Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance from an timestamp keeping the timezone to UTC.
 *                                                                                                                                                                                         Timestamp input can be given as int, float or a string containing one or more numbers.
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             createMidnightDate($year = null, $month = null, $day = null, $tz = null)                                                     Create a Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance from just a date. The time portion is set to midnight.
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon|false                                       createSafe($year = null, $month = null, $day = null, $hour = null, $minute = null, $second = null, $tz = null)               Create a new safe Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance from a specific date and time.
 *                                                                                                                                                                                         If any of $year, $month or $day are set to null their now() values will
 *                                                                                                                                                                                         be used.
 *                                                                                                                                                                                         If $hour is null it will be set to its now() value and the default
 *                                                                                                                                                                                         values for $minute and $second will be their now() values.
 ...
 *                                                                                                                                                                                         will be thrown.
 * @method CarbonInterface                                    createStrict(?int $year = 0, ?int $month = 1, ?int $day = 1, ?int $hour = 0, ?int $minute = 0, ?int $second = 0, $tz = null) Create a new Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance from a specific date and time using strict validation.
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             disableHumanDiffOption($humanDiffOption)                                                                                     @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
 *                                                                                                                                                                                                     You should rather use the ->settings() method.
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             enableHumanDiffOption($humanDiffOption)                                                                                      @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
 *                                                                                                                                                                                                     You should rather use the ->settings() method.
 ...
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             fromSerialized($value)                                                                                                       Create an instance from a serialized string.
 ...
 * @method Closure|Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                     getTestNow()                                                                                                                 Get the Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance (real or mock) to be returned when a "now"
 *                                                                                                                                                                                         instance is created.
 ...
 * @method \Enpii\WP_Plugin\Enpii_Base\Dependencies\Symfony\Component\Translation\TranslatorInterface getTranslator()                                                                                                              Get the default translator instance in use.
 ...
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             instance($date)                                                                                                              Create a Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance from a DateTime one.
 ...
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon|null                                        make($var)                                                                                                                   Make a Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance from given variable if possible.
 *                                                                                                                                                                                         Always return a new instance. Parse only strings and only these likely to be dates (skip intervals
 *                                                                                                                                                                                         and recurrences). Throw an exception for invalid format, but otherwise return null.
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             maxValue()                                                                                                                   Create a Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance for the greatest supported date.
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             minValue()                                                                                                                   Create a Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance for the lowest supported date.
 * @method void                                               mixin($mixin)                                                                                                                Mix another object into the class.
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             now($tz = null)                                                                                                              Get a Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance for the current date and time.
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             parse($time = null, $tz = null)                                                                                              Create a carbon instance from a string.
 *                                                                                                                                                                                         This is an alias for the constructor that allows better fluent syntax
 *                                                                                                                                                                                         as it allows you to do Carbon::parse('Monday next week')->fn() rather
 *                                                                                                                                                                                         than (new Carbon('Monday next week'))->fn().
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             parseFromLocale($time, $locale = null, $tz = null)                                                                           Create a carbon instance from a localized string (in French, Japanese, Arabic, etc.).
 * @method string                                             pluralUnit(string $unit)                                                                                                     Returns standardized plural of a given singular/plural unit name (in English).
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon|false                                       rawCreateFromFormat($format, $time, $tz = null)                                                                              Create a Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance from a specific format.
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             rawParse($time = null, $tz = null)                                                                                           Create a carbon instance from a string.
 *                                                                                                                                                                                         This is an alias for the constructor that allows better fluent syntax
 *                                                                                                                                                                                         as it allows you to do Carbon::parse('Monday next week')->fn() rather
 *                                                                                                                                                                                         than (new Carbon('Monday next week'))->fn().
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             resetMacros()                                                                                                                Remove all macros and generic macros.
 ...
 * @method void                                               resetToStringFormat()                                                                                                        Reset the format used to the default when type juggling a Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance to a string
 ...
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             setFallbackLocale($locale)                                                                                                   Set the fallback locale.
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             setHumanDiffOptions($humanDiffOptions)                                                                                       @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
 *                                                                                                                                                                                                     You should rather use the ->settings() method.
 ...
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             setTestNow($testNow = null)                                                                                                  Set a Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance (real or mock) to be returned when a "now"
 ...
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             setTestNowAndTimezone($testNow = null, $tz = null)                                                                           Set a Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance (real or mock) to be returned when a "now"
 *                                                                                                                                                                                         instance is created.  The provided instance will be returned
 *                                                                                                                                                                                         specifically under the following conditions:
 *                                                                                                                                                                                           - A call to the static now() method, ex. Carbon::now()
 *                                                                                                                                                                                           - When a null (or blank string) is passed to the constructor or parse(), ex. new Carbon(null)
 ...
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             setUtf8($utf8)                                                                                                               @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
 ...
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             today($tz = null)                                                                                                            Create a Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance for today.
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             tomorrow($tz = null)                                                                                                         Create a Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance for tomorrow.
 ...
 *                                                                                                                                                                                                     Or you can use method variants: addMonthsWithOverflow/addMonthsNoOverflow, same variants
 *                                                                                                                                                                                                     are available for quarters, years, decade, centuries, millennia (singular and plural forms).
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             useStrictMode($strictModeEnabled = true)                                                                                     @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
 *                                                                                                                                                                                                     You should rather use the ->settings() method.
 ...
 *                                                                                                                                                                                         /!\ Use this method for unit tests only.
 * @method Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon                                             yesterday($tz = null)                                                                                                        Create a Enpii\WP_Plugin\Enpii_Base\Dependencies\Carbon instance for yesterday.
 *
 * </autodoc>
 */
class Factory
