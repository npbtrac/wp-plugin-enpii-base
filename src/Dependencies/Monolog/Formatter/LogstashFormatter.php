...
class LogstashFormatter extends NormalizerFormatter
{
    ...
    /**
     * @var string the key for 'extra' fields from the Enpii\WP_Plugin\Enpii_Base\Dependencies\Monolog record
     */
    protected $extraKey;

    /**
     * @var string the key for 'context' fields from the Enpii\WP_Plugin\Enpii_Base\Dependencies\Monolog record
     */
