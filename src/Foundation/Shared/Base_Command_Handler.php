...
use Enpii\WP_Plugin\Enpii_Base\Foundation\Shared\Interfaces\Command_Handler_Interface;

/**
 * This works as the base one for other Command Handlers to inherit
 * @package Enpii\WP_Plugin\Enpii_Base\Foundation\Shared
 */
abstract class Base_Command_Handler implements Command_Handler_Interface {
}
