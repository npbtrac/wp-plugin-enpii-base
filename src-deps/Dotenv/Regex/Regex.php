...
namespace Enpii_Base\Deps\Dotenv\Regex;

use Enpii_Base\Deps\Dotenv\Result\Error;
use Enpii_Base\Deps\Dotenv\Result\Result;
...
class Regex
{
     ...
     *
     * @return \Enpii_Base\Deps\Dotenv\Result\Result<int,string>
     */
     ...
     *
     * @return \Enpii_Base\Deps\Dotenv\Result\Result<string,string>
     */
     ...
     * @param string             $subject
     *
     * @return \Enpii_Base\Deps\Dotenv\Result\Result<V,string>
     */
