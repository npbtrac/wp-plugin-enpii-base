...
namespace Enpii_Base\Deps\Illuminate\Database\Schema;

use BadMethodCallException;
use Closure;
use Enpii_Base\Deps\Illuminate\Database\Connection;
use Enpii_Base\Deps\Illuminate\Database\Query\Expression;
use Enpii_Base\Deps\Illuminate\Database\Schema\Grammars\Grammar;
use Enpii_Base\Deps\Illuminate\Database\SQLiteConnection;
...
class Blueprint
{
     ...
     *
     * @var \Enpii_Base\Deps\Illuminate\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     *
     * @var \Enpii_Base\Deps\Illuminate\Support\Fluent[]
     */
    protected $commands = [];
     ...
     *
     * @return \Enpii_Base\Deps\Illuminate\Support\Fluent
     */
     ...
     * @param  string|array  $columns
     * @param  string|null  $name
     * @return \Enpii_Base\Deps\Illuminate\Database\Schema\ForeignKeyDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \Enpii_Base\Deps\Illuminate\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \Enpii_Base\Deps\Illuminate\Database\Schema\ForeignIdColumnDefinition
     */
