...
class RedisJob extends Job implements JobContract
{
     ...
     *
     * @var \Enpii_Base\Deps\Illuminate\Queue\RedisQueue
     */
    protected $redis;
     ...
     * @param  \Enpii_Base\Deps\Illuminate\Queue\RedisQueue  $redis
     * @param  string  $job
     ...
     *
     * @return \Enpii_Base\Deps\Illuminate\Queue\RedisQueue
     */
