...
use Closure;
use Exception;
use Enpii_Base\Deps\Illuminate\Contracts\Cache\LockProvider;
use Enpii_Base\Deps\Illuminate\Contracts\Cache\Store;
use Enpii_Base\Deps\Illuminate\Database\ConnectionInterface;
use Enpii_Base\Deps\Illuminate\Database\PostgresConnection;
use Enpii_Base\Deps\Illuminate\Database\QueryException;
...
class DatabaseStore implements LockProvider, Store
{
     ...
     * @return \Enpii_Base\Deps\Illuminate\Contracts\Cache\Lock
     */
