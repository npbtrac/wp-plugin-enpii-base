...
use Closure;
use Enpii_Base\Deps\Cron\CronExpression;
...
use Enpii_Base\Deps\Illuminate\Contracts\Mail\Mailer;
...
use Enpii_Base\Deps\Illuminate\Support\Traits\ReflectsClosures;
use Psr\Http\Client\ClientExceptionInterface;
use Enpii_Base\Deps\Symfony\Component\Process\Process;
...
class Event
{
     ...
     *
     * @var \Enpii_Base\Deps\Illuminate\Console\Scheduling\EventMutex
     */
    public $mutex;
     ...
     *
     * @param  \Enpii_Base\Deps\Illuminate\Console\Scheduling\EventMutex  $mutex
    ...
    /**
     * Determine if the given event should run based on the Enpii_Base\Deps\Cron expression.
     *
    ...
    /**
     * Determine if the Enpii_Base\Deps\Cron expression passes.
     *
     * @return bool
     */
    ...
    protected function ensureOutputIsBeingCaptured()
    {
        if (is_null($this->output) || $this->output == $this->getDefaultOutput()) {
            $this->sendOutputTo(wp_app_storage_path('logs/schedule-'.sha1($this->mutexName()).'.log'));
        }
    }
     ...
     *
     * @param  \Enpii_Base\Deps\Illuminate\Contracts\Mail\Mailer  $mailer
    ...
    /**
     * Get the Enpii_Base\Deps\Cron expression for the event.
     *
     * @return string
     */
