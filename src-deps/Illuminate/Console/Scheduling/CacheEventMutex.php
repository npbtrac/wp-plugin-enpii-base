...
use Enpii_Base\Deps\Illuminate\Contracts\Cache\Factory as Cache;
...
class CacheEventMutex implements EventMutex, CacheAware
{
     ...
     *
     * @var \Enpii_Base\Deps\Illuminate\Contracts\Cache\Factory
     */
    public $cache;
     ...
     *
     * @param  \Enpii_Base\Deps\Illuminate\Contracts\Cache\Factory  $cache
     * @return void
     */
