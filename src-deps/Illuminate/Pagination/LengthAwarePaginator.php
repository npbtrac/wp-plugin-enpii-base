...
use ArrayAccess;
use Countable;
use Enpii_Base\Deps\Illuminate\Contracts\Pagination\LengthAwarePaginator as LengthAwarePaginatorContract;
...
class LengthAwarePaginator extends AbstractPaginator implements Arrayable, ArrayAccess, Countable, IteratorAggregate, Jsonable, JsonSerializable, LengthAwarePaginatorContract
{
     ...
     * @param  array  $data
     * @return \Enpii_Base\Deps\Illuminate\Contracts\Support\Htmlable
     */
