...
namespace Enpii_Base\Deps\Illuminate\Redis\Limiters;

use Enpii_Base\Deps\Illuminate\Contracts\Redis\LimiterTimeoutException;
...
class DurationLimiterBuilder
{
     ...
     *
     * @var \Enpii_Base\Deps\Illuminate\Redis\Connections\Connection
     */
    public $connection;
     ...
     * @return mixed
     *
     * @throws \Enpii_Base\Deps\Illuminate\Contracts\Redis\LimiterTimeoutException
     */
