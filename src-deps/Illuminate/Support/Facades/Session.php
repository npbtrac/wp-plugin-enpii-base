 ...
 * @method static void setRequestOnHandler(\Enpii_Base\Deps\Illuminate\Http\Request $request)
 *
 * @see \Enpii_Base\Deps\Illuminate\Session\SessionManager
 * @see \Enpii_Base\Deps\Illuminate\Session\Store
 */
