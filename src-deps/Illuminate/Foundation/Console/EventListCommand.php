...
use Enpii_Base\Deps\Illuminate\Foundation\Support\Providers\EventServiceProvider;
...
class EventListCommand extends Command
{
    ...
    protected function getEvents()
    {
        ...
        return wp_app_collect($events)->map(function ($listeners, $event) {
    ...
    protected function filterEvents(array $events)
    {
        ...
        return wp_app_collect($events)->filter(function ($listeners, $event) use ($eventName) {
