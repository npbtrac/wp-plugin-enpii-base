...
use Enpii_Base\Deps\Illuminate\Testing\Constraints\CountInDatabase;
use Enpii_Base\Deps\Illuminate\Testing\Constraints\HasInDatabase;
use Enpii_Base\Deps\Illuminate\Testing\Constraints\SoftDeletedInDatabase;
...
trait InteractsWithDatabase
{
     ...
     *
     * @param  \Enpii_Base\Deps\Illuminate\Database\Eloquent\Model|string  $table
     * @param  array  $data
     * @param  string|null  $connection
     * @return $this
     */
