...
use Enpii_Base\Deps\Monolog\Utils;
use PhpConsole\Connector;
use PhpConsole\Handler as VendorPhpConsoleHandler;
use PhpConsole\Helper;

/**
 * Enpii_Base\Deps\Monolog handler for Google Chrome extension "PHP Console"
 *
 ...
 *
 *      $logger = new \Enpii_Base\Deps\Monolog\Logger('all', array(new \Enpii_Base\Deps\Monolog\Handler\PHPConsoleHandler()));
 *      \Enpii_Base\Deps\Monolog\ErrorHandler::register($logger);
 *      echo $undefinedVar;
 ...
 * @deprecated Since 2.8.0 and 3.2.0, PHPConsole is abandoned and thus we will drop this handler in Enpii_Base\Deps\Monolog 4
 */
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private $options = [
        ...
        'classesPartialsTraceIgnore' => ['Enpii_Base\Deps\Monolog\\'], // array Hide calls of classes started with...
    ...
    /**
     * @param  array<string, mixed> $options   See \Enpii_Base\Deps\Monolog\Handler\PHPConsoleHandler::$options for more details
