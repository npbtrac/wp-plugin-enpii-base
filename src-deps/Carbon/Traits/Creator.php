...
use Enpii_Base\Deps\Carbon\Exceptions\InvalidDateException;
use Enpii_Base\Deps\Carbon\Exceptions\InvalidFormatException;
use Enpii_Base\Deps\Carbon\Exceptions\OutOfRangeException;
use Enpii_Base\Deps\Carbon\Translator;
use Closure;
 ...
 *
 * @method static Enpii_Base\Deps\Carbon|CarbonImmutable getTestNow()
 */
trait Creator
{
    ...
    /**
     * Create a new Enpii_Base\Deps\Carbon instance.
     *
    ...
    /**
     * Create a Enpii_Base\Deps\Carbon instance from a DateTime one.
     *
     * @param DateTimeInterface $date
     *
     * @return static
    ...
    /**
     * Get a Enpii_Base\Deps\Carbon instance for the current date and time.
     *
     * @param DateTimeZone|string|null $tz
     *
     * @return static
    ...
    /**
     * Create a Enpii_Base\Deps\Carbon instance for today.
     *
     * @param DateTimeZone|string|null $tz
     *
     * @return static
    ...
    /**
     * Create a Enpii_Base\Deps\Carbon instance for tomorrow.
     *
     * @param DateTimeZone|string|null $tz
     *
     * @return static
    ...
    /**
     * Create a Enpii_Base\Deps\Carbon instance for yesterday.
     *
     * @param DateTimeZone|string|null $tz
     *
     * @return static
    ...
    /**
     * Create a Enpii_Base\Deps\Carbon instance for the greatest supported date.
     *
     * @return static
     */
    ...
    /**
     * Create a Enpii_Base\Deps\Carbon instance for the lowest supported date.
     *
     * @return static
     */
    ...
    /**
     * Create a new Enpii_Base\Deps\Carbon instance from a specific date and time.
     *
    ...
    /**
     * Create a new safe Enpii_Base\Deps\Carbon instance from a specific date and time.
     *
     * If any of $year, $month or $day are set to null their now() values will
     * be used.
     *
    ...
    /**
     * Create a new Enpii_Base\Deps\Carbon instance from a specific date and time using strict validation.
     *
     * @see create()
     *
     * @param int|null                 $year
    ...
    /**
     * Create a Enpii_Base\Deps\Carbon instance from just a date. The time portion is set to now.
     *
     * @param int|null                 $year
     * @param int|null                 $month
     * @param int|null                 $day
    ...
    /**
     * Create a Enpii_Base\Deps\Carbon instance from just a date. The time portion is set to midnight.
     *
     * @param int|null                 $year
     * @param int|null                 $month
     * @param int|null                 $day
    ...
    /**
     * Create a Enpii_Base\Deps\Carbon instance from just a time. The date portion is set to today.
     *
     * @param int|null                 $hour
     * @param int|null                 $minute
     * @param int|null                 $second
    ...
    /**
     * Create a Enpii_Base\Deps\Carbon instance from a time string. The date portion is set to today.
     *
     * @param string                   $time
     * @param DateTimeZone|string|null $tz
     *
    ...
    /**
     * Create a Enpii_Base\Deps\Carbon instance from a specific format.
     *
     * @param string                         $format Datetime format
     * @param string                         $time
    ...
    public static function rawCreateFromFormat($format, $time, $tz = null)
    {
        ...
        /** @var \Enpii_Base\Deps\Carbon\CarbonImmutable|\Enpii_Base\Deps\Carbon\Carbon|null $mock */
    ...
    /**
     * Create a Enpii_Base\Deps\Carbon instance from a specific ISO format (same replacements as ->isoFormat()).
     *
     * @param string                                             $format     Datetime format
     * @param string                                             $time
     * @param DateTimeZone|string|false|null                     $tz         optional timezone
     * @param string|null                                        $locale     locale to be used for LTS, LT, LL, LLL, etc. macro-formats (en by fault, unneeded if no such macro-format in use)
     * @param \Enpii_Base\Deps\Symfony\Component\Translation\TranslatorInterface $translator optional custom translator to use for macro-formats
     *
     * @throws InvalidFormatException
     *
     * @return static|false
    ...
    /**
     * Create a Enpii_Base\Deps\Carbon instance from a specific format and a string in a given language.
     *
     * @param string                         $format Datetime format
     * @param string                         $locale
     * @param string                         $time
    ...
    /**
     * Create a Enpii_Base\Deps\Carbon instance from a specific ISO format and a string in a given language.
     *
    ...
    /**
     * Make a Enpii_Base\Deps\Carbon instance from given variable if possible.
     *
