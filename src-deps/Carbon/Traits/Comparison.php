...
use Enpii_Base\Deps\Carbon\Exceptions\BadComparisonUnitException;
...
trait Comparison
{
     ...
     * ```
     *
     * @param \Enpii_Base\Deps\Carbon\Carbon|\DateTimeInterface|mixed $date
     *
     * @see equalTo()
     *
     * @return bool
     ...
     * ```
     *
     * @param \Enpii_Base\Deps\Carbon\Carbon|\DateTimeInterface|mixed $date1
     * @param \Enpii_Base\Deps\Carbon\Carbon|\DateTimeInterface|mixed $date2
     ...
     * @param \Enpii_Base\Deps\Carbon\Carbon|\DateTimeInterface|string|null $date   instance to compare with or null to use current day.
     *
     * @return bool
     */
     ...
     * @param \Enpii_Base\Deps\Carbon\Carbon|\DateTimeInterface|null $date instance to compare with or null to use current day.
     *
     ...
     * ```
     *
     * @param \Enpii_Base\Deps\Carbon\Carbon|\DateTimeInterface|string|null $date       The instance to compare with or null to use current day.
     ...
     * ```
     *
     * @param \Enpii_Base\Deps\Carbon\Carbon|\DateTimeInterface|null $date       The instance to compare with or null to use the current date.
     * @param bool                                   $ofSameYear Check if it is the same month in the same year.
     *
     * @return bool
     */
     ...
     * ```
     *
     * @param \Enpii_Base\Deps\Carbon\Carbon|\DateTimeInterface|null $date The instance to compare with or null to use current day.
     *
     * @return bool
     */
