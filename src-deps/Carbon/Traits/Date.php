...
trait Date
{
    ...
    /**
     * Get the TimeZone associated with the Enpii_Base\Deps\Carbon instance (as CarbonTimeZone).
     *
     ...
     *
     * @param Enpii_Base\Deps\Carbon|DateTimeInterface|string|null $date
     *
     * @return static
     */
    ...
    /**
     * Return the Enpii_Base\Deps\Carbon instance passed through, a now instance in UTC
    ...
    public function get($name)
    {
        ...
        switch (true) {
            ...
            // @property-read string long name of weekday translated according to Enpii_Base\Deps\Carbon locale, in english if no translation available for current language
            case $name === 'dayName':
                return $this->getTranslatedDayName();
            // @property-read string short name of weekday translated according to Enpii_Base\Deps\Carbon locale, in english if no translation available for current language
            case $name === 'shortDayName':
                return $this->getTranslatedShortDayName();
            // @property-read string very short name of weekday translated according to Enpii_Base\Deps\Carbon locale, in english if no translation available for current language
            case $name === 'minDayName':
                return $this->getTranslatedMinDayName();
            // @property-read string long name of month translated according to Enpii_Base\Deps\Carbon locale, in english if no translation available for current language
            case $name === 'monthName':
                return $this->getTranslatedMonthName();
            // @property-read string short name of month translated according to Enpii_Base\Deps\Carbon locale, in english if no translation available for current language
            case $name === 'shortMonthName':
                return $this->getTranslatedShortMonthName();
            // @property-read string lowercase meridiem mark translated according to Enpii_Base\Deps\Carbon locale, in latin if no translation available for current language
            case $name === 'meridiem':
                return $this->meridiem(true);
            // @property-read string uppercase meridiem mark translated according to Enpii_Base\Deps\Carbon locale, in latin if no translation available for current language
