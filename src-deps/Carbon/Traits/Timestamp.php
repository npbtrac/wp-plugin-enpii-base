...
{
    /**
     * Create a Enpii_Base\Deps\Carbon instance from a timestamp and set the timezone (use default one if not specified).
     *
    ...
    /**
     * Create a Enpii_Base\Deps\Carbon instance from an timestamp keeping the timezone to UTC.
     *
     * Timestamp input can be given as int, float or a string containing one or more numbers.
     *
     * @param float|int|string $timestamp
    ...
    /**
     * Create a Enpii_Base\Deps\Carbon instance from a timestamp in milliseconds.
     *
     * Timestamp input can be given as int, float or a string containing one or more numbers.
     *
     * @param float|int|string $timestamp
