...
trait ToStringFormat
{
    ...
    /**
     * Reset the format used to the default when type juggling a Enpii_Base\Deps\Carbon instance to a string
     *
     * @return void
     */
     ...
     *             You should rather let Enpii_Base\Deps\Carbon object being cast to string with DEFAULT_TO_STRING_FORMAT, and
     *             use other method or custom format passed to format() method if you need to dump another string
     *             format.
     *
     * Set the default format used when type juggling a Enpii_Base\Deps\Carbon instance to a string.
     */
