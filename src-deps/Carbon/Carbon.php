...
use Enpii_Base\Deps\Carbon\Traits\Date;
use Enpii_Base\Deps\Carbon\Traits\DeprecatedProperties;
use DateTime;
 ...
 * @method        static Enpii_Base\Deps\Carbon|false createFromFormat(string $format, string $time, string|DateTimeZone $timezone = null) Parse a string into a new Enpii_Base\Deps\Carbon object according to the specified format.
 * @method        static Enpii_Base\Deps\Carbon       __set_state(array $array)                                                            https://php.net/manual/en/datetime.set-state.php
 *
 * </autodoc>
 */
