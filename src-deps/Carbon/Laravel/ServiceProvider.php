...
namespace Enpii_Base\Deps\Carbon\Laravel;
...
use Enpii_Base\Deps\Illuminate\Events\Dispatcher;
use Enpii_Base\Deps\Illuminate\Support\Carbon as IlluminateCarbon;
use Enpii_Base\Deps\Illuminate\Support\Facades\Date;
use Enpii_Base\Deps\Symfony\Component\EventDispatcher\EventDispatcher;
use Throwable;
    ...
    public function updateLocale()
    {
        ...
        if (class_exists(Date::class)) {
            try {
                ...
                // Non Enpii_Base\Deps\Carbon class in use in Date facade
            }
        }
    }
