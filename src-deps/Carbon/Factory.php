...
/**
 * A factory to generate Enpii_Base\Deps\Carbon instances with common settings.
 *
 ...
 *                                                                                                                                                                                         new instance.
 * @method Enpii_Base\Deps\Carbon|false                                       create($year = 0, $month = 1, $day = 1, $hour = 0, $minute = 0, $second = 0, $tz = null)                                     Create a new Enpii_Base\Deps\Carbon instance from a specific date and time.
 ...
 *                                                                                                                                                                                         will be 0.
 * @method Enpii_Base\Deps\Carbon                                             createFromDate($year = null, $month = null, $day = null, $tz = null)                                                         Create a Enpii_Base\Deps\Carbon instance from just a date. The time portion is set to now.
 * @method Enpii_Base\Deps\Carbon|false                                       createFromFormat($format, $time, $tz = null)                                                                                 Create a Enpii_Base\Deps\Carbon instance from a specific format.
 * @method Enpii_Base\Deps\Carbon|false                                       createFromIsoFormat($format, $time, $tz = null, $locale = 'en', $translator = null)                                          Create a Enpii_Base\Deps\Carbon instance from a specific ISO format (same replacements as ->isoFormat()).
 * @method Enpii_Base\Deps\Carbon|false                                       createFromLocaleFormat($format, $locale, $time, $tz = null)                                                                  Create a Enpii_Base\Deps\Carbon instance from a specific format and a string in a given language.
 * @method Enpii_Base\Deps\Carbon|false                                       createFromLocaleIsoFormat($format, $locale, $time, $tz = null)                                                               Create a Enpii_Base\Deps\Carbon instance from a specific ISO format and a string in a given language.
 * @method Enpii_Base\Deps\Carbon                                             createFromTime($hour = 0, $minute = 0, $second = 0, $tz = null)                                                              Create a Enpii_Base\Deps\Carbon instance from just a time. The date portion is set to today.
 * @method Enpii_Base\Deps\Carbon                                             createFromTimeString($time, $tz = null)                                                                                      Create a Enpii_Base\Deps\Carbon instance from a time string. The date portion is set to today.
 * @method Enpii_Base\Deps\Carbon                                             createFromTimestamp($timestamp, $tz = null)                                                                                  Create a Enpii_Base\Deps\Carbon instance from a timestamp and set the timezone (use default one if not specified).
 *                                                                                                                                                                                         Timestamp input can be given as int, float or a string containing one or more numbers.
 * @method Enpii_Base\Deps\Carbon                                             createFromTimestampMs($timestamp, $tz = null)                                                                                Create a Enpii_Base\Deps\Carbon instance from a timestamp in milliseconds.
 *                                                                                                                                                                                         Timestamp input can be given as int, float or a string containing one or more numbers.
 * @method Enpii_Base\Deps\Carbon                                             createFromTimestampMsUTC($timestamp)                                                                                         Create a Enpii_Base\Deps\Carbon instance from a timestamp in milliseconds.
 *                                                                                                                                                                                         Timestamp input can be given as int, float or a string containing one or more numbers.
 * @method Enpii_Base\Deps\Carbon                                             createFromTimestampUTC($timestamp)                                                                                           Create a Enpii_Base\Deps\Carbon instance from an timestamp keeping the timezone to UTC.
 *                                                                                                                                                                                         Timestamp input can be given as int, float or a string containing one or more numbers.
 * @method Enpii_Base\Deps\Carbon                                             createMidnightDate($year = null, $month = null, $day = null, $tz = null)                                                     Create a Enpii_Base\Deps\Carbon instance from just a date. The time portion is set to midnight.
 * @method Enpii_Base\Deps\Carbon|false                                       createSafe($year = null, $month = null, $day = null, $hour = null, $minute = null, $second = null, $tz = null)               Create a new safe Enpii_Base\Deps\Carbon instance from a specific date and time.
 *                                                                                                                                                                                         If any of $year, $month or $day are set to null their now() values will
 *                                                                                                                                                                                         be used.
 *                                                                                                                                                                                         If $hour is null it will be set to its now() value and the default
 *                                                                                                                                                                                         values for $minute and $second will be their now() values.
 ...
 *                                                                                                                                                                                         will be thrown.
 * @method CarbonInterface                                    createStrict(?int $year = 0, ?int $month = 1, ?int $day = 1, ?int $hour = 0, ?int $minute = 0, ?int $second = 0, $tz = null) Create a new Enpii_Base\Deps\Carbon instance from a specific date and time using strict validation.
 * @method Enpii_Base\Deps\Carbon                                             disableHumanDiffOption($humanDiffOption)                                                                                     @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
 *                                                                                                                                                                                                     You should rather use the ->settings() method.
 * @method Enpii_Base\Deps\Carbon                                             enableHumanDiffOption($humanDiffOption)                                                                                      @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
 *                                                                                                                                                                                                     You should rather use the ->settings() method.
 ...
 * @method Enpii_Base\Deps\Carbon                                             fromSerialized($value)                                                                                                       Create an instance from a serialized string.
 ...
 * @method Closure|Enpii_Base\Deps\Carbon                                     getTestNow()                                                                                                                 Get the Enpii_Base\Deps\Carbon instance (real or mock) to be returned when a "now"
 *                                                                                                                                                                                         instance is created.
 ...
 * @method \Enpii_Base\Deps\Symfony\Component\Translation\TranslatorInterface getTranslator()                                                                                                              Get the default translator instance in use.
 ...
 * @method Enpii_Base\Deps\Carbon                                             instance($date)                                                                                                              Create a Enpii_Base\Deps\Carbon instance from a DateTime one.
 ...
 * @method Enpii_Base\Deps\Carbon|null                                        make($var)                                                                                                                   Make a Enpii_Base\Deps\Carbon instance from given variable if possible.
 *                                                                                                                                                                                         Always return a new instance. Parse only strings and only these likely to be dates (skip intervals
 *                                                                                                                                                                                         and recurrences). Throw an exception for invalid format, but otherwise return null.
 * @method Enpii_Base\Deps\Carbon                                             maxValue()                                                                                                                   Create a Enpii_Base\Deps\Carbon instance for the greatest supported date.
 * @method Enpii_Base\Deps\Carbon                                             minValue()                                                                                                                   Create a Enpii_Base\Deps\Carbon instance for the lowest supported date.
 * @method void                                               mixin($mixin)                                                                                                                Mix another object into the class.
 * @method Enpii_Base\Deps\Carbon                                             now($tz = null)                                                                                                              Get a Enpii_Base\Deps\Carbon instance for the current date and time.
 * @method Enpii_Base\Deps\Carbon                                             parse($time = null, $tz = null)                                                                                              Create a carbon instance from a string.
 *                                                                                                                                                                                         This is an alias for the constructor that allows better fluent syntax
 *                                                                                                                                                                                         as it allows you to do Carbon::parse('Monday next week')->fn() rather
 *                                                                                                                                                                                         than (new Carbon('Monday next week'))->fn().
 * @method Enpii_Base\Deps\Carbon                                             parseFromLocale($time, $locale = null, $tz = null)                                                                           Create a carbon instance from a localized string (in French, Japanese, Arabic, etc.).
 * @method string                                             pluralUnit(string $unit)                                                                                                     Returns standardized plural of a given singular/plural unit name (in English).
 * @method Enpii_Base\Deps\Carbon|false                                       rawCreateFromFormat($format, $time, $tz = null)                                                                              Create a Enpii_Base\Deps\Carbon instance from a specific format.
 * @method Enpii_Base\Deps\Carbon                                             rawParse($time = null, $tz = null)                                                                                           Create a carbon instance from a string.
 *                                                                                                                                                                                         This is an alias for the constructor that allows better fluent syntax
 *                                                                                                                                                                                         as it allows you to do Carbon::parse('Monday next week')->fn() rather
 *                                                                                                                                                                                         than (new Carbon('Monday next week'))->fn().
 * @method Enpii_Base\Deps\Carbon                                             resetMacros()                                                                                                                Remove all macros and generic macros.
 ...
 * @method void                                               resetToStringFormat()                                                                                                        Reset the format used to the default when type juggling a Enpii_Base\Deps\Carbon instance to a string
 ...
 * @method Enpii_Base\Deps\Carbon                                             setFallbackLocale($locale)                                                                                                   Set the fallback locale.
 * @method Enpii_Base\Deps\Carbon                                             setHumanDiffOptions($humanDiffOptions)                                                                                       @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
 *                                                                                                                                                                                                     You should rather use the ->settings() method.
 ...
 * @method Enpii_Base\Deps\Carbon                                             setTestNow($testNow = null)                                                                                                  Set a Enpii_Base\Deps\Carbon instance (real or mock) to be returned when a "now"
 ...
 * @method Enpii_Base\Deps\Carbon                                             setTestNowAndTimezone($testNow = null, $tz = null)                                                                           Set a Enpii_Base\Deps\Carbon instance (real or mock) to be returned when a "now"
 *                                                                                                                                                                                         instance is created.  The provided instance will be returned
 *                                                                                                                                                                                         specifically under the following conditions:
 *                                                                                                                                                                                           - A call to the static now() method, ex. Carbon::now()
 *                                                                                                                                                                                           - When a null (or blank string) is passed to the constructor or parse(), ex. new Carbon(null)
 ...
 * @method Enpii_Base\Deps\Carbon                                             setUtf8($utf8)                                                                                                               @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
 ...
 * @method Enpii_Base\Deps\Carbon                                             today($tz = null)                                                                                                            Create a Enpii_Base\Deps\Carbon instance for today.
 * @method Enpii_Base\Deps\Carbon                                             tomorrow($tz = null)                                                                                                         Create a Enpii_Base\Deps\Carbon instance for tomorrow.
 ...
 *                                                                                                                                                                                                     Or you can use method variants: addMonthsWithOverflow/addMonthsNoOverflow, same variants
 *                                                                                                                                                                                                     are available for quarters, years, decade, centuries, millennia (singular and plural forms).
 * @method Enpii_Base\Deps\Carbon                                             useStrictMode($strictModeEnabled = true)                                                                                     @deprecated To avoid conflict between different third-party libraries, static setters should not be used.
 *                                                                                                                                                                                                     You should rather use the ->settings() method.
 ...
 *                                                                                                                                                                                         /!\ Use this method for unit tests only.
 * @method Enpii_Base\Deps\Carbon                                             yesterday($tz = null)                                                                                                        Create a Enpii_Base\Deps\Carbon instance for yesterday.
 *
 * </autodoc>
 */
class Factory
