...
use Enpii_Base\Deps\Carbon\Exceptions\EndLessPeriodException;
use Enpii_Base\Deps\Carbon\Exceptions\InvalidCastException;
use Enpii_Base\Deps\Carbon\Exceptions\InvalidIntervalException;
use Enpii_Base\Deps\Carbon\Exceptions\InvalidPeriodDateException;
use Enpii_Base\Deps\Carbon\Exceptions\InvalidPeriodParameterException;
use Enpii_Base\Deps\Carbon\Exceptions\NotACarbonClassException;
use Enpii_Base\Deps\Carbon\Exceptions\NotAPeriodException;
use Enpii_Base\Deps\Carbon\Exceptions\UnknownGetterException;
use Enpii_Base\Deps\Carbon\Exceptions\UnknownMethodException;
use Enpii_Base\Deps\Carbon\Exceptions\UnreachableException;
use Enpii_Base\Deps\Carbon\Traits\IntervalRounding;
use Enpii_Base\Deps\Carbon\Traits\Mixin;
use Enpii_Base\Deps\Carbon\Traits\Options;
use Enpii_Base\Deps\Carbon\Traits\ToStringFormat;
use Closure;
use Countable;
use DateInterval;
use DatePeriod;
...
class CarbonPeriod implements Iterator, Countable, JsonSerializable
{
     ...
     *
     * @param CarbonPeriod|\DateTimeInterface|Enpii_Base\Deps\Carbon|CarbonImmutable|string $rangeOrRangeStart
     * @param \DateTimeInterface|Enpii_Base\Deps\Carbon|CarbonImmutable|string|null         $rangeEnd
     *
     * @return bool
     */
     ...
     * @example
     * ```
     * Carbon::create('2020-11-29')->daysUntil('2020-12-24')->forEach(function (Enpii_Base\Deps\Carbon $date) {
     ...
     * echo implode("\n", iterator_to_array($period->map(function (Enpii_Base\Deps\Carbon $date) {
     ...
     *
     * @param \Enpii_Base\Deps\Carbon\Carbon|\Enpii_Base\Deps\Carbon\CarbonPeriod|\Enpii_Base\Deps\Carbon\CarbonInterval|\DateInterval|\DatePeriod|\DateTimeInterface|string|null $date
     *
     * @return bool
     */
     ...
     *
     * @param \Enpii_Base\Deps\Carbon\CarbonPeriod|\DatePeriod|string $period
     *
     * @return bool
     */
     ...
     * @SuppressWarnings(PHPMD.UnusedFormalParameter)
     *
     * @param \Enpii_Base\Deps\Carbon\Carbon $current
     * @param int            $key
     *
     * @return bool|string
     */
    ...
    /**
     * Return the Enpii_Base\Deps\Carbon instance passed through, a now instance in the same timezone
     * if null given or parse the input if string given.
     *
     * @param \Enpii_Base\Deps\Carbon\Carbon|\Enpii_Base\Deps\Carbon\CarbonPeriod|\Enpii_Base\Deps\Carbon\CarbonInterval|\DateInterval|\DatePeriod|\DateTimeInterface|string|null $date
     *
     * @return \Enpii_Base\Deps\Carbon\CarbonInterface
     */
