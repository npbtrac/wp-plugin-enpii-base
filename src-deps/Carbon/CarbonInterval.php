...
use Enpii_Base\Deps\Carbon\Exceptions\BadFluentConstructorException;
use Enpii_Base\Deps\Carbon\Exceptions\BadFluentSetterException;
use Enpii_Base\Deps\Carbon\Exceptions\InvalidCastException;
use Enpii_Base\Deps\Carbon\Exceptions\InvalidIntervalException;
use Enpii_Base\Deps\Carbon\Exceptions\ParseErrorException;
use Enpii_Base\Deps\Carbon\Exceptions\UnitNotConfiguredException;
use Enpii_Base\Deps\Carbon\Exceptions\UnknownGetterException;
use Enpii_Base\Deps\Carbon\Exceptions\UnknownSetterException;
use Enpii_Base\Deps\Carbon\Exceptions\UnknownUnitException;
use Enpii_Base\Deps\Carbon\Traits\IntervalRounding;
use Enpii_Base\Deps\Carbon\Traits\IntervalStep;
...
class CarbonInterval extends DateInterval implements CarbonConverterInterface
{
     ...
     *
     * @throws \Enpii_Base\Deps\Carbon\Exceptions\ParseErrorException when the $interval cannot be parsed as an interval.
     *
     * @return static
     */
    ...
    public function forHumans($syntax = null, $short = false, $parts = -1, $options = null)
    {
        ...
        /** @var \Enpii_Base\Deps\Symfony\Component\Translation\Translator $translator */
